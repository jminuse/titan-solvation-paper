...
def run(test_molecule_filename, makefile):
	...
	if test_molecule_name[-1]=='2': test_molecule_name = test_molecule_name[:-1]
...
makefile.write('all :')
for test_molecule_filename in ['../acetylene.arc', '../micelle/hcn2.arc', '../micelle/acetonitrile2.arc']:
	test_molecule_name = test_molecule_filename[ test_molecule_filename.rindex('/')+1 :-4]
	if test_molecule_name[-1]=='2': test_molecule_name = test_molecule_name[:-1]
...
#for filename in ['../micelle/propanenitrile.arc', '../acetylene.arc', '../micelle/acrylonitrile2.arc', '../micelle/hcn2.arc', '../micelle/acetonitrile2.arc']: #acrylonitrile was made with different file, check saved version
for filename in ['../acetylene.arc', '../micelle/hcn2.arc', '../micelle/acetonitrile2.arc']:

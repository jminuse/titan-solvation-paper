...
def run(molecule_name, solvent_ratio):
	...
	run_prefix = molecule_name+'_atm__'
	...
	print molecule_name,
	if not free_energies_forward: print 'No data'
	print '%.3e,' % sum(free_energies_forward),
	print '%.3e,' % sum([(average_dHs[i]+average_dHs[i+1])*0.5/n_steps for i in range(len(average_dHs)-1)]),
	print '%.3e' % sum(free_energies_backward)
...
#for molecule_name in ['propanenitrile','N2','acetylene','acrylonitrile','hexane','acetonitrile']: #old
#for molecule_name in ['propanenitrile','acrylonitrile', 'acetylene', 'hcn', 'acetonitrile']: #solid
#for molecule_name in ['propanenitrile', 'acrylonitrile', 'acetylene', 'hcn', 'acetonitrile', 'N2']: #fep_gas.py, fep_liquid.py
for molecule_name in ['N2']: #redone separately
